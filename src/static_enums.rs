...
impl PropName {
    pub fn from_str(name: &str) -> Option<Self> {
        match name {
            "age" => Some(PropName::Age),
            "attached" => Some(PropName::Attached),
            "attachment" => Some(PropName::Attachment),
            "axis" => Some(PropName::Axis),
            "berries" => Some(PropName::Berries),
            "bites" => Some(PropName::Bites),
            "bloom" => Some(PropName::Bloom),
            "bottom" => Some(PropName::Bottom),
            "can_summon" => Some(PropName::CanSummon),
            "candles" => Some(PropName::Candles),
            "charges" => Some(PropName::Charges),
            "conditional" => Some(PropName::Conditional),
            "cracked" => Some(PropName::Cracked),
            "delay" => Some(PropName::Delay),
            "disarmed" => Some(PropName::Disarmed),
            "distance" => Some(PropName::Distance),
            "down" => Some(PropName::Down),
            "drag" => Some(PropName::Drag),
            "dusted" => Some(PropName::Dusted),
            "east" => Some(PropName::East),
            "eggs" => Some(PropName::Eggs),
            "enabled" => Some(PropName::Enabled),
            "extended" => Some(PropName::Extended),
            "eye" => Some(PropName::Eye),
            "face" => Some(PropName::Face),
            "facing" => Some(PropName::Facing),
            "flower_amount" => Some(PropName::FlowerAmount),
            "half" => Some(PropName::Half),
            "hanging" => Some(PropName::Hanging),
            "has_book" => Some(PropName::HasBook),
            "has_bottle_0" => Some(PropName::HasBottle0),
            "has_bottle_1" => Some(PropName::HasBottle1),
            "has_bottle_2" => Some(PropName::HasBottle2),
            "has_record" => Some(PropName::HasRecord),
            "hatch" => Some(PropName::Hatch),
            "hinge" => Some(PropName::Hinge),
            "honey_level" => Some(PropName::HoneyLevel),
            "in_wall" => Some(PropName::InWall),
            "instrument" => Some(PropName::Instrument),
            "inverted" => Some(PropName::Inverted),
            "layers" => Some(PropName::Layers),
            "leaves" => Some(PropName::Leaves),
            "level" => Some(PropName::Level),
            "lit" => Some(PropName::Lit),
            "locked" => Some(PropName::Locked),
            "mode" => Some(PropName::Mode),
            "moisture" => Some(PropName::Moisture),
            "north" => Some(PropName::North),
            "note" => Some(PropName::Note),
            "occupied" => Some(PropName::Occupied),
            "open" => Some(PropName::Open),
            "orientation" => Some(PropName::Orientation),
            "part" => Some(PropName::Part),
            "persistent" => Some(PropName::Persistent),
            "pickles" => Some(PropName::Pickles),
            "power" => Some(PropName::Power),
            "powered" => Some(PropName::Powered),
            "rotation" => Some(PropName::Rotation),
            "sculk_sensor_phase" => Some(PropName::SculkSensorPhase),
            "shape" => Some(PropName::Shape),
            "short" => Some(PropName::Short),
            "shrieking" => Some(PropName::Shrieking),
            "signal_fire" => Some(PropName::SignalFire),
            "slot_0_occupied" => Some(PropName::Slot0Occupied),
            "slot_1_occupied" => Some(PropName::Slot1Occupied),
            "slot_2_occupied" => Some(PropName::Slot2Occupied),
            "slot_3_occupied" => Some(PropName::Slot3Occupied),
            "slot_4_occupied" => Some(PropName::Slot4Occupied),
            "slot_5_occupied" => Some(PropName::Slot5Occupied),
            "snowy" => Some(PropName::Snowy),
            "south" => Some(PropName::South),
            "stage" => Some(PropName::Stage),
            "thickness" => Some(PropName::Thickness),
            "tilt" => Some(PropName::Tilt),
            "triggered" => Some(PropName::Triggered),
            "type" => Some(PropName::Type),
            "unstable" => Some(PropName::Unstable),
            "up" => Some(PropName::Up),
            "vertical_direction" => Some(PropName::VerticalDirection),
            "waterlogged" => Some(PropName::Waterlogged),
            "west" => Some(PropName::West),
            s => Some(PropName::Other(s.to_string())),
        }
    }
